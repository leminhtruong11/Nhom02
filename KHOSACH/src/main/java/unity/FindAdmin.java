 ...
 * @author Minh Nguyet
 */
public class FindAdmin extends javax.swing.JFrame {
...
for (int i = rowCount - 1; i >= 0; i--) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FindAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                String abc=null;
                new FindAdmin(abc).setVisible(true);
            }
        });
    }
