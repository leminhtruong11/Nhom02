...
public class InhoadonXuatsach extends javax.swing.JFrame {

    /**
     * Creates new form InhoadonNhapsach
     */
    public InhoadonXuatsach(List<Sach> list, Nhanvien nhanvien, String day, String time, String mhdn) {
        initComponents();
        int sum=0;
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Mã sách", "Tên sách", "Tác giả", "Thể loại", "Số lượng", "Đơn giá"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InhoadonXuatsach.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
          ...
          //      txtKhachhang.setText(txtNXB.getText());
                ...
                String time=null;
                String mhdn=null;
                new InhoadonXuatsach(list,nhanvien,day,time,mhdn).setVisible(true);
            }
        });
    }
